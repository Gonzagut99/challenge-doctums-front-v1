...
const Footer = () => {
  return (
    <footer className="bg-black backdrop-blur-md">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="relative md:flex mx-auto md:justify-between">
          <div className="mb-6 mx-auto md:mb-0">
            <a href="" className="flex items-center">
              <img src="/assets/landing/logo_doctums.png" className="h-12 me-3" alt="FlowBite Logo" />
            </a>
          </div>
