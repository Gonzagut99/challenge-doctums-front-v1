...
export default function Example() {
  return (
    <div className="relative mx-auto isolate overflow-hidden px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="lg:max-w-lg">
              ...
              <p className="mt-6 text-xl/8 font-montserrat text-black">
        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base/7 font-montserrat text-black lg:max-w-lg">
              <p>
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600">
                <li className="flex gap-x-3">
                  ...
                  <span className='text-black'>
                    <strong className="font-semibold text-black">Objetivo.</strong> Enfrentar con éxito los eventos que se presenten a lo largo del año, haciendo uso de las "eficiencias" de tu área de Gestión del Cambio (GC), que representan habilidades clave.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <ProblemaIcon aria-hidden="true" className="mt-1 size-5 flex-none text-celeste" />
                  <span className='text-black'>
                    <strong className="font-semibold text-black">Las eficiencias</strong> Se desarrollan adquiriendo productos, contratando recursos, y ejecutando subproyectos, cada uno de los cuales tiene un costo.
                  </span>
                </li>
                <li className="flex gap-x-3">
                  <EstrategiaIcon aria-hidden="true" className="mt-1 size-5 flex-none text-celeste" />
                  <span className='text-black'>
                    <strong className="font-semibold text-black"> Líder de Proyecto</strong> Tendrás que gestionar el presupuesto mensual asignado al inicio del año, decidiendo cómo invertir en el fortalecimiento de tu área y prepararla para enfrentar los eventos de cada mes. 
                  </span>
                </li>
              </ul>
              <p className="mt-8">
              ...
              <h2 className="mt-16 text-2xl font-bold tracking-tight text-black"></h2>
